...
describe('Grid tests', () => {
  it('get column count', () => {
    const grid: GridSystem = new GridManager(14, 10)

    expect(grid.getColCount()).to.be.eq(14)
  })

  it('get row count', () => {
    const grid: GridSystem = new GridManager(13, 11)
  ...
  it('get tileSize changed value', () => {
    const grid: GridSystem = new GridManager(13, 11, 27)

    expect(grid.getTileSize()).to.be.eq(27)
  })

  it('get grid cells count', () => {
    const grid: GridSystem = new GridManager(5, 5)
